...
<section class="data_forms">
   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         <div class="inputBox">
            <span>Last Name:</span>
            <input type="text" name="last_name" value="<?= $data['last_name']; ?>" class="box" readonly>
         </div>
         <div class="inputBox">
            <span>First Name:</span>
            <input type="text" name="first_name" value="<?= $data['first_name']; ?>" class="box" readonly>
         </div>
         <div class="inputBox">
      ...
      <a href="forms.php"><input type="button" name="submit_new" class="btn" value="Submit New Form"></a>
      <a href="forms_edit.php"><input type="button" name="edit" class="btn" value="Edit"></a>
      <a href="home.php"><input type="button" name="home" class="btn" value="Home"></a>
   </form>
